...
const opts = {
  preflightCommitment: "processed" //  we simply wait for our transaction to be confirmed by the node we're connected to. This is generally okay
  // but if you wanna be super super sure you may use something like "finalized"
}
